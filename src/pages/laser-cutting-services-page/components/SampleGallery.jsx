      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-secondary max-w-3xl mx-auto">
            Discover our portfolio of intricate laser cutting projects showcasing precision and design complexity across various materials.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-text-secondary">
                  This project showcases our precision laser cutting capabilities, demonstrating intricate pattern work and exceptional edge quality for detailed fabrication projects.
                </p>
              </div>
            </div>
          </div>
