...
const PlottingServicesPage = () => {
  ...
  const pageDescription = `Expert ${pageData.title} in Nairobi. We use high-precision machines for your custom plotting projects. Get a free quote for your custom project today at Luna Graphics.`;
